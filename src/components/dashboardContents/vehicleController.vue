...
@click="deleteData(item.id)"
 ...
 <v-col cols="12">
     <v-overflow-btn :items="dropdown_type" label="Type*" v-model="form.type">
    </v-overflow-btn>
 </v-col>
 <v-col cols="12">
 ...
 <v-col cols="12">
 <v-text-field label="createdAt*" v-model="form.created_at" required></v-text-field>
 </v-col>
 </v-row>
 </v-container>
...
export default {
 ...
 var uri = this.$apiUrl
+ '/vehicle/' + deleteId; //data dihapus berdasarkan id
